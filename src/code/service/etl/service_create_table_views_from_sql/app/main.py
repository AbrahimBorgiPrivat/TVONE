...
if __name__ == "__main__":
    ...
    runtime_base = current_dir.parent / "runtime_definitions" / "create_table_and_views" / "runtime"
    runner_module = os.getenv("RUNNER_MODULE", "libraries.runners.create_table_and_views_from_sql")
    runtime_files_env = os.getenv("RUNTIME_FILES", "d_date.json")
